...
public class ESClientFactory {
    ...
    private ElasticsearchClient buildClient() {
        ...
        synchronized (this) {
            ...
            var restClient = RestClient.builder(HttpHost.create(esConfig.getApiUrl()))
                    .setDefaultHeaders(new Header[]{new BasicHeader("Authorization", "ApiKey " + esConfig.getApiKey())})
