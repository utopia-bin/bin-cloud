...
public class ApplicationDTO extends JsonSerializable {
    ...
    @NotBlank @Pattern(regexp = "[a-z][a-z0-9-]{1,99}")
    private String serviceId;
    @Schema(description = "ENABLED启用、DISABLED停用、OFFLINE下架")
    @NotBlank @Pattern(regexp = "ENABLED|DISABLED|OFFLINE")
    @NotNull
    ...
    @Valid @NotNull @Size(max = 20)
    private List<@NotNull RedirectDTO> redirectUris = new java.util.ArrayList<>();
}
