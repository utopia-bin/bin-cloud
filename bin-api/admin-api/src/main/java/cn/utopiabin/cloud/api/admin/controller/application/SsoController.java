...
public class SsoController {
    ...
    public RestResult<SsoAuthorizeVO> authorize(@RequestHeader("Authorization") String authorization,@Valid @RequestBody SsoAuthorizeDTO dto) {
    ...
    public RestResult<SsoTokenVO> exchange(@Valid @RequestBody SsoExchangeDTO dto) { return RestResult.ok(api.exchange(dto)); }
    @PostMapping("/refresh")
    @Operation(summary="应用后端轮换刷新令牌")
    public RestResult<SsoTokenVO> refresh(@Valid @RequestBody SsoRefreshDTO dto) { return RestResult.ok(api.refresh(dto)); }
}
